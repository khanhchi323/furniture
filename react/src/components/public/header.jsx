...
import Background from "../../assets/public/bg.jpg";
...
export default function Header() {
    return (
        <div
            className="bg-cover bg-center h-screen align-middle"
        ...
        >
            ...
            >
                <div className="flex lg:flex-1 h-[8vh] text-white justify-between">
                    ...
                    <div className="hidden lg:flex lg:gap-x-12 m-[4vh]">
                        <a
                            href="#"
                            class="text-md font-semibold leading-6 text-white-900 hover:text-yellow-100"
                        >
                            Home
                        </a>
                        <a
                    ...
                    <div class="m-[4vh] flex-row  items-center">
                        <a
                            href="#"
                            class=" block lg:flex flex-row lg:gap-x-6 -mx-3  rounded-lg px-3  font-semibold leading-6  text-white "
                        >
            ...
            <div className="flex justify-center items-center flex-col  h-[40vh] ">
                <p className="font-roboto leading-6 text-yellow-400 text-5xl drop-shadow-lg shadow-black">
                    Enjoy a part of every day
                </p>
                <p className="font-semibold text-white mt-12">
                    Product by CCHLB
                </p>
            </div>
